...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//'nested' function can access the variable 'INTERNAL' because its in the same scope.
...
function greeting(firstName, lastName){
  ...
  //console.log(greeting('Sean', 'Marsden'));
...
const cubeParams = {length:4, width:5, height:5}

  const cuboid = new CuboidMaker(cubeParams);
...
const cuboidTwo = new CuboidMakerTwo(cubeParams)
